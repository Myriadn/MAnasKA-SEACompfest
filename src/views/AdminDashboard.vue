<template>
  <div class="min-h-screen flex flex-col">
    ...
    <div class="container mx-auto px-4 py-8">
      ...
      <!-- Admin tools section -->
      <div class="card bg-base-100 shadow-lg mb-6 mt-8">
        <div class="card-body">
          <h2 class="card-title">Admin Tools</h2>
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
            <router-link to="/schema-checker" class="btn btn-primary">
              Database Schema Checker
            </router-link>
            <router-link to="/security-testing" class="btn btn-secondary">
              Security Testing Dashboard
            </router-link>
            <a href="#" class="btn btn-accent"> System Logs </a>
          </div>
        </div>
      </div>

...
export const SubscriptionService = {
  ...
  async createSubscription(data) {
    ...
    // and strip any HTML tags that might have been inserted
    const sanitizedData = {
      name: stripHtmlTags(validateInput(data.name, 'name')),
      ...
      allergies: stripHtmlTags(validateInput(data.allergies, 'optional')),

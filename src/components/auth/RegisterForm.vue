  ...
  methods: {
    ...
    async submitForm() {
      ...
      try {
        ...
        // Password is not sanitized as it should be kept exactly as entered
        // It's handled securely by the authentication system

        // Get CSRF token to protect signup request - handled by apiSecurity.js
        // This ensures CSRF protection is in place for the registration request

        // Add CSRF token to request headers
        await AuthService.signUp(sanitizedEmail, this.form.password, sanitizedFullName)
